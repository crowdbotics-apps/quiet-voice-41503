"""
Django settings for quiet_voice_41503 project.
...
ROOT_URLCONF = 'quiet_voice_41503.urls'
...
WSGI_APPLICATION = 'quiet_voice_41503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_voice_41503 API",
    "DESCRIPTION": "API documentation for quiet_voice_41503 App",
    "VERSION": "v1",
}
